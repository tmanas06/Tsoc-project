<script>
    ...
    function goToBusinessRegistration() {
        goto('/business');
    }
...
<div class="min-h-screen bg-[#ADD8E6] flex flex-col justify-center py-12 sm:px-6 lg:px-8">
            ...
            <form class="space-y-6" on:submit={handleSubmit}>
                ...
                <div class="flex items-center justify-between">
                    <div class="flex items-center">
                        <input id="remember_me" name="remember_me" type="checkbox" bind:checked={rememberMe}
